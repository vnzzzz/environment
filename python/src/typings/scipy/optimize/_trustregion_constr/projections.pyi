...
def qr_factorization_projections(A, m, n, orth_tol, max_refin, tol): # -> tuple[(x: Unknown) -> Unknown, (x: Unknown) -> Unknown, (x: Unknown) -> Unknown] | tuple[(x: Unknown) -> Unknown, (x: Unknown) -> NDArray[float64], (x: Unknown) -> Unknown]:

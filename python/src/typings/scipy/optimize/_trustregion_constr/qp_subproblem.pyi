...
def sphere_intersections(z, d, trust_radius, entire_line=...):
...
def box_intersections(z, d, lb, ub, entire_line=...):
...
def box_sphere_intersections(z, d, lb, ub, trust_radius, entire_line=..., extra_info=...): # -> tuple[Any, Any, bool, dict[str, Unknown], dict[str, Unknown]] | tuple[Any, Any, bool]:

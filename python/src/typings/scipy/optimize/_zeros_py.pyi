...
class TOMS748Solver:
    ...
    def solve(self, f, a, b, args=..., xtol=..., rtol=..., k=..., maxiter=..., disp=...): # -> tuple[Unknown, int, int, Literal[0]] | tuple[float, int, int, Literal[0]] | tuple[Any | float | Unknown, int, int, Literal[0]] | tuple[Any | float | Unknown, int, int, Literal[-2]]:

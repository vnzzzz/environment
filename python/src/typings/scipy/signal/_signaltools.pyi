...
def choose_conv_method(in1, in2, mode=..., measure=...):
    """
...
def convolve(in1, in2, mode=..., method=...):
    """
...
def deconvolve(signal, divisor): # -> tuple[Unknown | list[Unknown], NDArray[Unknown] | Unknown]:
...
def invres(r, p, k, tol=..., rtype=...): # -> tuple[poly1d | NDArray[bool_] | Literal[0], NDArray[Any] | NDArray[bool_]]:
...
def invresz(r, p, k, tol=..., rtype=...): # -> tuple[Unknown | Any | ndarray[Any, dtype[bool_]], NDArray[Any] | NDArray[bool_]]:
...
def detrend(data, axis=..., type=..., bp=..., overwrite_data=...):
    """

...
def periodogram(x, fs=..., window=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=...):
    """
...
def spectrogram(x, fs=..., window=..., nperseg=..., noverlap=..., nfft=..., detrend=..., return_onesided=..., scaling=..., axis=..., mode=...):

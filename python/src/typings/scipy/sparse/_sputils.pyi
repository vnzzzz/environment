...
supported_dtypes = ...
_upcast_memo = ...
def upcast(*args): # -> Type[bool_] | csingle | single | byte | ubyte:
...
def upcast_char(*args): # -> Type[bool_] | csingle | single | byte | ubyte:
...
def get_sum_dtype(dtype): # -> int_ | uint:
...
def check_shape(args, current_shape=...):

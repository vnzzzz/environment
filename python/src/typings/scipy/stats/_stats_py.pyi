...
@_axis_nan_policy_factory(lambda x: x, n_samples=1, n_outputs=1, too_small=0, paired=True, result_to_tuple=lambda x: (x, ), kwd_samples=['weights'])
def pmean(a, p, *, axis=..., dtype=..., weights=...):
...
ModeResult = ...
def mode(a, axis=..., nan_policy=..., keepdims=...):
...
def moment(a, moment=..., axis=..., nan_policy=...): # -> float64 | NDArray[Unknown]:
...
KurtosistestResult = ...
def kurtosistest(a, axis=..., nan_policy=..., alternative=...):
...
def scoreatpercentile(a, per, limit=..., interpolation_method=..., axis=...): # -> float | NDArray[float64]:
...
def zscore(a, axis=..., ddof=..., nan_policy=...):
    """
    Compute the z score.
...
def gzscore(a, *, axis=..., ddof=..., nan_policy=...):
    """
...
def zmap(scores, compare, axis=..., ddof=..., nan_policy=...):
    """
...
_scale_conversions = ...
def iqr(x, axis=..., rng=..., scale=..., nan_policy=..., interpolation=..., keepdims=...):
    r"""
...
def power_divergence(f_obs, f_exp=..., ddof=..., axis=..., lambda_=...):
...
def chisquare(f_obs, f_exp=..., ddof=..., axis=...):
...
def ks_1samp(x, cdf, args=..., alternative=..., method=...):
    """
...
@_rename_parameter("mode", "method")
def ks_2samp(data1, data2, alternative=..., method=...):
    """
...
def kruskal(*samples, nan_policy=...):
...
def combine_pvalues(pvalues, method=..., weights=...):
    """
